#ifndef EXPANSION_TELEMETRY_03_H
#define EXPANSION_TELEMETRY_03_H

#include "fw_types.h"

/* 繁體中文註解：telemetry 子系統第 03 階段，用來擴大假 firmware 架構並測試索引器壓力。 */
typedef struct fw_telemetry_03_state {
    uint32_t counter;
    uint32_t watermark;
    uint32_t last_event;
    fw_status_t last_status;
} fw_telemetry_03_state_t;
